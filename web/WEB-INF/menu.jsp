<%-- 
    Document   : menu
    Created on : 17 juin 2021, 16:13:10
    Author     : neveR
--%>
    ...
    <body>
        <div><nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#">DEV3</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav nav-fill w-100">
                            <a class="nav-item nav-link" href="addMemo"><i style="color: steelblue" class="fa fa-plus fa-2x"></i></a>
